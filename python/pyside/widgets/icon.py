...
from pyside.widgets.pixmap import Pixmap
...
class Icon(QtGui.QIcon):
    ...
    def fa(cls, path, **kwargs):
        ...
        default = {
            "on_active": kwargs.get("active", Pixmap(path)),
            "off_active": kwargs.get("active", Pixmap(path)),
            "on_disabled": kwargs.get("disabled", Pixmap(path)),
            "off_disabled": kwargs.get("disabled", Pixmap(path)),
            "on_selected": kwargs.get("selected", Pixmap(path)),
            "off_selected": kwargs.get("selected", Pixmap(path)),
